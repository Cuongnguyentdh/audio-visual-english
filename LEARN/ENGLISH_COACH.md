...
```mermaid
graph LR
    A[1. Nạp 1 Mẫu Khung Câu<br/>1 Core Pattern] --> B[2. Ghép Từ & Thay Thế<br/>Substitution Drill]
    B --> C[3. Đối Thoại Ngắn 1-1<br/>Micro Role-Play]
    C --> D[4. Sửa Lỗi & Tổng Kết<br/>Feedback & Polish]
```
